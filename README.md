...
equiparate::max_far(nrow = 1, ncol = 3, max_far = 4/3, filename = "max_far_nrow1_ncol3_maxfar4div3_chart.pdf")
```
![](https://github.com/lbuk/equiparate/blob/master/img/max_far_nrow1_ncol3_maxfar4div3_chart.png)

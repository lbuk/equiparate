...
max_far(nrow = 3, ncol = 1, max_far = 4/3, filename = "max_far_nrow3_ncol1_maxfar4div3_chart.pdf")
```
...
```
![](https://github.com/lbuk/equiparate/blob/master/img/equal_gsi_nrow4_ncol3_gsi5div6_chart.png)
